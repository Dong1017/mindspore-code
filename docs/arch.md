...
(see `docs/impl/ms-cli/ms-cli-refactor.md`). It is the single contributor-facing
...
The following packages are removed by the refactor (see `docs/impl/ms-cli/ms-cli-refactor.md`):
...
- `docs/impl/ms-cli/ms-cli-refactor.md` — refactor plan (workstream A)
- `docs/impl/ms-skills/ms-skills-update-plan.md` — skills plan (workstream B)
- `docs/design/factory/incubating-factory-plan.md` — factory plan (workstream C)
