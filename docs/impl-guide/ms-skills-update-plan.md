...
The `docs/design/incubating-factory-plan.md` was written before the impl guide and
...
layout). The authoritative Factory design is now `docs/design/ms-factory-impl-guide.md`.
